...
\begin{enumerate}[label=\textup{(\roman*)}]
 ...
 Structural Carrier Theorem. It is conditionally discharged
 (Thm.~\ref{thm:scc-mcs-full}) at the declared structural scope;
 until it is proved \emph{unconditionally} (canonically, without the
 stated conditions), the SCC branch cannot advance beyond conditional
 CERT-CLOSE to unconditional closure. Silent carrier inflation remains
 a structural risk.
