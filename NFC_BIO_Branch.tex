...
\begin{openobligation}[\status{C}]\label{ob:bio-EVO-bridge-cond}
...
\begin{openobligation}[\status{C}]\label{ob:bio-MULTI-coordination}
...
\begin{openobligation}[\status{C}]\label{ob:bio-MULTI-coord-concrete}
