...
\begin{enumerate}[label=\textup{(\alph*)}]
 ...
 against the \emph{same contracting} quantity --- or, equivalently,
 a direct closed contracting recurrence for
 $\mathcal{O}_{\mathrm{NS}}$ itself.
...
or, equivalently, its direct closed contracting recurrence for
$\mathcal{O}_{\mathrm{NS}}$.
...
\emph{The exhaustive inflow accounting}
$\Psi_k = E_k + B_k$ --- equivalently, the assignment of every
per-step channel (level stock, transported survivor
$\Theta_k C_k$, transported loss $(1-\Theta_k)C_k$, interior and
boundary defect increments $E_k, B_k$, renewal inflow, redistribution,
remainder), including in particular the assignment or exclusion of
the transported loss $(1-\Theta_k)C_k$ --- is \emph{not} available
in current canon: no decomposition theorem defines
$\Psi^{\mathrm{int}}, \Psi^{\mathrm{bdry}}$ from the canonical
$\Psi$, and no proved map connects $\Psi^{\mathrm{int}}$ to $E_k$.
It is precisely part~(e) of
...
Under that hypothesised discharge, $\Psi_k = E_k + B_k$.
...
(b+c)\,\mathfrak{D}_k$) --- or a direct closed contracting
recurrence for $\mathcal{O}_{\mathrm{NS}}$ --- is supplied here
\emph{only} by the discharge of
