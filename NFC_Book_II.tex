...
% ============================================================
\begin{remark}[\status{R}]\label{cap:book2-status}
\textbf{Current Status Capsule.} \emph{Current posture:} Local structure, boundary law, and stabilization: stable [U]/[C] layer. See Book~VII governance and \texttt{NFC\_STATE\_OF\_CANON.md} for the corpus-wide record.
\end{remark}
