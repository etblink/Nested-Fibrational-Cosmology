...
% ============================================================
\begin{remark}[\status{R}]\label{cap:book4-status}
\textbf{Current Status Capsule.} \emph{Current posture:} The Universal Source and completion ladder: stable [U] layer. See Book~VII governance and \texttt{NFC\_STATE\_OF\_CANON.md} for the corpus-wide record.
\end{remark}
