...
% ============================================================
\begin{remark}[\status{R}]\label{cap:book5-status}
\textbf{Current Status Capsule.} \emph{Current posture:} Descents, projections, and certified branch legitimacy (UBLT): stable [U]/[C] layer. See Book~VII governance and \texttt{NFC\_STATE\_OF\_CANON.md} for the corpus-wide record.
\end{remark}
