...
%% Current status: Conditional CERT-CLOSE (MSC-normalized NFC scope); B1/B2/B3 post-program. See prop:YM-status / cap:YM-status.
%% Constitutional intake (as constituted): CERT-PROJ direction; not yet CERT-CLOSE. [retained as intake; superseded by prop:YM-status — MIG-005]
%%
%% Status legend:
...
% ============================================================
\begin{remark}[\status{R}]\label{cap:YM-status}
\textbf{Current Status Capsule.}
\emph{Current posture:} Conditional CERT-CLOSE at MSC-normalized, persistence-selected NFC scope; the three Clay gaps B1/B2/B3 remain open post-program obligations (conditionally discharged at NFC scope, open at Clay scope).

\emph{Authoritative source:} \ref{prop:YM-status}~(final status proposition (current posture)).

\emph{Frontier accountings (never summed): syntactic~[O] in this branch --- 0; reduced irreducible frontier --- none directly (SM matter is downstream); branch posture --- conditional CERT-CLOSE (MSC-normalized), B1/B2/B3 post-program.}
...
\begin{obligation}[\status{C}]\label{ob:O-YM-SLC}
...
\begin{obligation}[\status{C}]\label{ob:O-YM-WeakGlue}
...
\begin{obligation}[\status{C}]\label{ob:YM-B3-A2}
...
\begin{obligation}[\status{C}]\label{ob:O-YM-WeakGlue-standalone}
...
\begin{obligation}[\status{C}]\label{ob:O-YM-SVC}
...
\begin{obligation}[\status{C}]\label{ob:O-YM-SVC-Lip}
...
\begin{obligation}[\status{C}]\label{ob:O-ID}
...
\begin{obligation}[\status{C}]\label{ob:O-RIG}
...
\begin{obligation}[\status{C}]\label{ob:O-ENC}
...
\begin{obligation}[\status{C}]\label{ob:O-GLOB}
...
\begin{obligation}[\status{C}]\label{ob:O-CLU}
...
\begin{obligation}[\status{C}]\label{ob:O-ID-cont}
...
\begin{obligation}[\status{C}]\label{ob:YM-B1}
...
\begin{obligation}[\status{C}]\label{ob:YM-B2}
...
\begin{obligation}[\status{C}]\label{ob:YM-B3}
...
\begin{obligation}[\status{C}]\label{ob:B3-A2-reserve}
...
\begin{obligation}[\status{C}]\label{ob:B1-ClaySpec}
...
\begin{obligation}[\status{C}]\label{ob:Planck-SI-calibration}
