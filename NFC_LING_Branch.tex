...
\begin{openobligation}[\status{C}]\label{ob:ling-CR}
...
\begin{openobligation}[\status{C}]\label{ob:ling-CL}
...
\begin{openobligation}[\status{C}]\label{ob:ling-CM}
...
\begin{openobligation}[\status{C}]\label{ob:ling-NC}
...
\begin{openobligation}[\status{C}]\label{ob:ling-GD}
...
\begin{openobligation}[\status{C}]\label{ob:ling-REC}
...
\begin{openobligation}[\status{C}]\label{ob:ling-SEM}
...
\begin{openobligation}[\status{C}]\label{ob:ling-END}
...
\begin{openobligation}[\status{C}]\label{ob:ling-REC-open}
...
\begin{openobligation}[\status{C}]\label{ob:ling-SEM-open}
...
\begin{openobligation}[\status{C}]\label{ob:ling-rec-infty}
...
\begin{openobligation}[\status{C}]\label{ob:ling-rec-infty-bridge}
...
\begin{openobligation}[\status{C}]\label{ob:ling-rec-bridge-eps}
...
\begin{openobligation}[\status{C}]\label{ob:ling-SEM-ref-open}
...
\begin{openobligation}[\status{C}]\label{ob:ling-ref-probe-nomination}
...
\begin{openobligation}[\status{C}]\label{ob:ling-ref-formal}
